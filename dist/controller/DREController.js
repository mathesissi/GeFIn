...
const DREService_1 = require("../service/DREService");
const express = __importStar(require("express"));
let DREController = class DREController extends tsoa_1.Controller {
    constructor() {
        super();
        this.service = new DREService_1.DREService();
    }
    /**
     * Gera a Demonstração do Resultado do Exercício (DRE) para um período específico.
     */
    async getDRE(mes, ano, request, badRequestResponse) {
        // Validação básica
        if (!mes || !ano) {
