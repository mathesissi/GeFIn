...
let BalancoPatrimonialController = class BalancoPatrimonialController extends tsoa_1.Controller {
    async getBalancoPatrimonial(mes, ano, request) {
        const user = request.user;
        const service = new BalancoPatrimonialService_1.BalancoPatrimonialService();
...
], BalancoPatrimonialController.prototype, "getBalancoPatrimonial", null);
