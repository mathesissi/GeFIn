...
const LivroDiarioService_1 = require("../service/LivroDiarioService");
const express = __importStar(require("express"));
let LivroDiarioController = class LivroDiarioController extends tsoa_1.Controller {
    async getLivroDiario(mes, ano, request) {
        const user = request.user;
        const service = new LivroDiarioService_1.LivroDiarioService();
...
], LivroDiarioController.prototype, "getLivroDiario", null);
