// id_conta, nome_conta, tipo_conta (Ativo, Passivo, Receita, Despesa), codigo_conta
...
enum TipoConta {
  ...
  // Subtipos para Patrimônio Líquido (se quiser mais no futuro, fica aberto)
  enum SubtipoPatrimonioLiquido {
  ...
  class Conta {
    ...
    subtipo_conta?: string; // será validado conforme o tipo
    codigo_conta: string;
