...
export class EmpresaService {
    ...
    public async criarEmpresa(empresa: Empresa): Promise<Empresa> {
    ...
    public async buscarEmpresaPorId(id: number): Promise<Empresa | null> {
     ...
     * @returns A Empresa ou null.
     */
    public async buscarEmpresaPorCnpj(cnpj: string): Promise<Empresa | null> {
